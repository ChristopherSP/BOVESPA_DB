...
conn = sqlite3.connect('BOVESPA')
conn.text_factory = str
cur = conn.cursor()

pasta = '/home/user/Downloads/Hist_Bovespa/'

farquivos = raw_input('Enter file name: ')

if len(farquivos)<1: farquivos = pasta+'arquivos.txt'

with open(farquivos,'r') as arquivos:
	for fname in arquivos:
		print fname
		with open(pasta+fname.rstrip(),'r') as file:
			...
			for line in lines[1:-1]: 
				...
				cur.execute('INSERT OR IGNORE INTO CODBDI(id,nome) VALUES(?,?)',(codbdi_id,None))
